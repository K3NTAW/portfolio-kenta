    ...
    >
        ...
        <div ref="navSections" class="nav__sections">
            ...
            <ul
                ...
                :style="{ '--sections-length': visibleSections.length }"
            >
                <li
                    ...
                    :class="{
                        ...
                        nav__sections__list__separator: section.isSeparator
                    }"
                    @click="handleSectionClick(section)"
                    @keypress.enter.space.prevent="handleSectionClick(section)"
                >
                    {{ section.label }}
                </li>
            </ul>
            ...
            <ul
                ...
                ref="navPagesList"
                class="nav__sections__list"
                :style="{ '--sections-length': visiblePages.length }"
            >
                <li
                    v-for="(page, key) in visiblePages"
                    :key="key"
                    ref="navPagesListSections"
                    role="button"
                    tabindex="0"
                    class="nav__sections__list__section"
                    @click="handlePageClick(page)"
                    @keypress.enter.space.prevent="handlePageClick(page)"
                >
                    {{ page.label }}
                </li>
            </ul>
...
export default {
    ...
    computed: {
        visibleSections() {
            return this.sections.filter((section) => !section.isSeparator);
        },
        visiblePages() {
            return this.pages;
        }
    ...
    methods: {
        ...
        handleSectionClick(section) {
            if (!section.isSeparator) {
                this.$scrollTo(section.scrollTo);
            }
        },
...
.nav {
    ...
    &__menu-button {
        ...
        &__list__separator {
            ...
            border-top: 1px solid #ccc; // Example border styling
        }
    }
}
</style>
